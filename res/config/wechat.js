...
Vue.http.get(env.api + 'wechat/sign',{
    ...
    linkUrl = 'https://' + window.location.host + '/product.html?id=' + utility.getUrlParam('id') + '&shareId=' + (utility.getUrlParam('shareId') ? localStorage['share_openid'] : localStorage['openId'])
